...
export function confirmationHtml(c: BookingConfirmation): string {
  const first = c.customerName.split(' ')[0] ?? c.customerName;
  return `<div style="font-family:system-ui,sans-serif;max-width:520px">
    ...
    <table style="width:100%;border-collapse:collapse">
      <tr><td>Reference</td><td align="right"><b>${c.reference}</b></td></tr>
      <tr><td>Service</td><td align="right">${c.serviceName}</td></tr>
      <tr><td>Stylist</td><td align="right">${c.stylistName}</td></tr>
      <tr><td>When</td><td align="right">${c.whenLabel}</td></tr>
